    ...
    reply_html_page(
        ...
        [ div(class(container),
              [ \html_requires(css('entrada.css')),
                ...
                \line,
                \titulo_da_paginaBairro('Meus Bairros '),
                \line,
                \tabela_de_bookmarksbai

              ]) ]).

titulo_da_paginaBairro(Titulo) -->
...
tabela_de_bookmarksbai -->
    html(div(class('container-fluid py-3'),
             [
               \cabeca_da_tabelaBairro('     ', '/','voltar'),
               \cabeca_da_tabelaBairro('Bairros', '/bairro','Novo Bairro'),
               \tabelabai
             ]
            )).


cabeca_da_tabelaBairro(Titulo,Link,Nome) -->
